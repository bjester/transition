...
(function($)
{
  var global = this,
      ...
      Transform = Transition.generators.transform,
      key = 'translate3d';
  
  /**
   * 
   * @param {Array} props Should be formatted [1, 5, 10] in pixels
   * @returns {undefined}
   */
  var Translate = function(props)
  {
    $(this).one(Transition.START, function()
    {
      $(this).css(Transform.build(Translate.build(props)));
    });    
  };
